...
const routes = [
  // Public routes with layout
  {
    ...
    children: [
      ...
      { path: 'about', name: 'About', component: PublicHome },
      { path: 'contact', name: 'Contact', component: PublicHome },
      { path: 'help', name: 'Help', component: PublicHome },
      { path: 'privacy', name: 'Privacy', component: PublicHome },
      { path: 'terms', name: 'Terms', component: PublicHome },
    ]
  },
...
router.beforeEach((to, from, next) => {
  ...
  const publicRoutes = [
    '/login', '/register', '/', '/categories', '/books', '/about', 
